    ...
    Background:
        Given store has default configuration
          ...
          And the following promotions exist:
            ...
            | 3 items             | 15 dis on order         | true       |
            | 300 EUR             | 40 dis on order                  | true       |
            | Shipping to Germany | 40 EUR Discount for orders with shipping country Germany | true       |
            | Ubuntu T-Shirts     | 40 EUR Discount for Ubuntu T-Shirts                      | true       |
            | 3rd order           | 10 EUR Discount for 3rd order                            | true       |
